...
void main(int argc, char const *argv[])
{
	...
	// Create tasks:
	rt_task_create(&task_1,"task_1",0,10,0);
	rt_task_create(&task_2,"task_2",0,20,0);
	rt_task_create(&task_3,"task_3",0,30,0);
	rt_task_create(&task_4,"task_4",0,40,0);
	rt_task_create(&task_5,"task_5",0,50,0);
